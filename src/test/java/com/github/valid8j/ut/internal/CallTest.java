...
public class CallTest extends TestBase {
  ...
  public void functionsCanBeChained() {
    ...
    Function<String, String> chained = Functions.<String, String>call("substring", 7).andThen(call("toUpperCase"));
  ...
  public void covariantOverridingMethodCanBeInvokedCorrectly() {
    Object r = call("method", "Hello").apply(new ExtendsBase());
  ...
  public void parameterUnmatchedWhileNameMatching() {
    try {
      call("method", 123).apply(new Base());
