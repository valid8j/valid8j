...
import static com.github.dakusui.valid8j.pcond.forms.Functions.stringify;
import static com.github.dakusui.valid8j.pcond.internals.InternalUtils.getMethod;
...
public class FunctionsTest {
  ...
  public static class MultiFunctionTest extends TestBase {
    ...
    public void toStringMultiParameterFunction$thenExpectedValueReturned() {
      MultiFunction<String> func = greeting(0, 1);
      assertEquals("com.github.dakusui.valid8j_pcond.ut.FunctionsTest$MultiFunctionTest$TargetMethodHolder.greeting(String,String)", func.toString());
    }
    ...
    public void toStringMultiParameterFunction$withReversedOrder$thenExpectedValueReturned() {
      MultiFunction<String> func = greeting(1, 0);
      assertEquals("com.github.dakusui.valid8j_pcond.ut.FunctionsTest$MultiFunctionTest$TargetMethodHolder.greeting(String,String)(1,0)", func.toString());
    }
